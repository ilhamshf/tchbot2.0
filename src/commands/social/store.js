...
class Store extends Command {
  constructor(...args) {
    super(...args, {
      ...
      extendedHelp: "Examples:\n  **t.store add 1000 VIP** (sell VIP role for ¥1000)\n  **t.store add 0 Cool Guy** (Sell the Cool Guy role for free)\n  **t.store buy VIP** (buy the role.)\n  **t.store sell VIP** (sell and remove the role for a 50% refund)",
