...
class Prefix extends Command {
  ...
  async reset(msg) {
    if(msg.guild.settings.prefix === "t.") return msg.send("The prefix is already the default.");
    await msg.guild.update({ prefix: "t." });
    return msg.send("Reset the prefix for this server to `t.`");
  }
}
