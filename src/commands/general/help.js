...
class Help extends Command {
  ...
  async run(msg, [command]) {
    if(command) {
      ...
      return msg.send(this.client.embed(this.client.user)
        ...
        .setDescription([
          ...
          `**Usage:** ${msg.guild ? msg.guild.prefix : "t."}${cmd.usage}`,
          `**Cost:** ${cost}`,
    ...
    const embed = this.client.embed(this.client.user)
      ...
      .setDescription("Bergabung ke [Discord Server](https://discord.gg/C7kgHCRYMW) untuk mendapatkan informasi dan pembaruan!")
      .setFooter("For more information about a command run t.help <command>");
