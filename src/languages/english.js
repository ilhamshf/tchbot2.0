...
module.exports = new Language("english", "English", {
  ...
  DID_YOU_MEAN: (cmd) => `|\`❔\`| Mungkin yang anda maksud \`${cmd}\`?`,
  NONE: "None",
  SECONDS: "Seconds",
  BLACKLISTED: "You've been blacklisted from using the bot for abusive reasons. Please join https://discord.gg/C7kgHCRYMW or contact Ravener#5796 for a chance to appeal.",
  BLACKLISTED_GUILD: (guild) => `The server **${guild.name}** has been blacklisted from using the bot. If you are an Admin of the server please join https://discord.gg/C7kgHCRYMW or contact Ravener#5796 for a chance to appeal.`,
  ...
  COMMAND_STATS_DESCRIPTION: "Hi, I'm TCHBot. The all-in-one entertainment bot for your server brought to you by my master Ravener#5796",
  COMMAND_STATS_TITLE: "TCHBot - Bot Statistics",
  ...
  COMMAND_ANNOUNCEMENTS_FOOTER: (prefix) => `From TCHBot Lounge (Use ${prefix}support to join us)`,
  COMMAND_SUPPORT_DESCRIPTION: "Get the link to our support server.",
  COMMAND_SUPPORT_TITLE: "Join TCHBot Lounge",
  COMMAND_POKEMON_GUESS: "You have 15 seconds to guess! Who's that Pokèmon?",
  COMMAND_SLOTS_TITLE: "TCHBot Slots",
