...
module.exports = new Language("german", "Deutsch", {
  ...
  COMMAND_STATS_DESCRIPTION: "Hi, ich bin TCHBot. Der All-in-One Unterhaltungsbot für deinen Server von meinem Meister Ravener#5796",
  COMMAND_STATS_TITLE: "TCHBot - Botstatistiken",
  ...
  COMMAND_ANNOUNCEMENTS_FOOTER: (prefix) => `Von der TCHBot Lounge (Benutz ${prefix}support um uns beizutreten)`,
  COMMAND_SUPPORT_DESCRIPTION: "Hol dir den Link zu unserem Support-Server",
  COMMAND_SUPPORT_TITLE: "Tritt der TCHBot Lounge bei.",
