...
module.exports = new Language("indonesian", "Bahasa Indonesia", {
  ...
  NONE: "Tidak ada",
  SECONDS: "Detik",
  BLACKLISTED: "Kamu telah masuk blacklist dari penggunaan bot karena alasan penyalahgunaan bot. Silahkan bergabung ke https://discord.gg/C7kgHCRYMW atau menghubungi Ravener#5796 untuk mendapatkan kesempatan mengajukan permohonan.",
  BLACKLISTED_GUILD: (guild) => `Server **${guild.name}** telah masuk blacklist dari penggunaan bot. Jika Kamu adalah Admin server, silakan bergabung ke https://discord.gg/C7kgHCRYMW atau menghubungi Ravener#5796 untuk mendapatkan kesempatan mengajukan permohonan.`,

  WELCOME_MESSAGES: [
  "O-ohayou gozaimasu **{{user}}**.",
  "Ini bukan seperti aku menyukaimu atau apapun... tapi selamat datang di server **{{user}}**.",
  "O-oh, selamat datang **{{user}}**. Aku harap, Aku tidak membuatmu tidak nyaman...",
  ...
  "Kamu baru saja mendapatkan **{{amount}}**? Mungkin kamu bisa membelikanku makan malam kapan-kapan **{{user}}**? :wink:",
  ...
  "Hmph, Kamu telah naik level **{{level}}**, **{{user}}**. W-well, tidak ada bedanya bagiku!",
  "Hyaa~! Kamu telah naik level**{{user}}**, level kamu sekarang **{{level}}**.",
  "**{{user}}**, jangan lupakan aku! Hanya karena kamu sudah level **{{level}}**",
  ...
  COMMAND_STATS_DESCRIPTION: "Hai, Saya TCHBot. Bot hiburan all-in-one untuk server Kamu. dipersembahkan oleh tuanku Ravener#5796",
  COMMAND_STATS_TITLE: "TCHBot - Statistik Bot",
  ...
  COMMAND_ANNOUNCEMENTS_FOOTER: (prefix) => `Dari TCHBot Lounge (Gunakan ${prefix}support untuk bergabung dengan kami)`,
  COMMAND_SUPPORT_DESCRIPTION: "Dapatkan tautan ke server support kami.",
  COMMAND_SUPPORT_TITLE: "Bergabunglah dengan TCHBot Lounge",
