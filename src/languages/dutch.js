...
module.exports = new Language("dutch", "Nederlands", {
  ...
  OWNER_ONLY: "Stot. Wat denk je dat je aan het doen bent? Die commando is alleen voor mijn meester!",
  GUILD_ONLY: "Stot. U kunt deze commando alleen in een server gebruiken. Wat doe je in mijn directe berichten?",
  ...
  COMMAND_STATS_DESCRIPTION: "Hallo, ik ben TCHBot. alles in één entertainment bot voor uw server gebracht aan u door mijn meester Ravener#5796",
  COMMAND_ANNOUNCEMENTS_TITLE: "Bot-aankondigingen!",
  COMMAND_ANNOUNCEMENTS_FOOTER: (prefix) => `Van TCHBot Lounge (gebruik ${prefix}support om bij ons te voegen)`,
  COMMAND_SAY: "Ik zal zeggen wat je wilt",
  COMMAND_SAY_WHAT: "Stot. Wat wil je dat ik zeg?",
